...
def home(request):
    ...
    if not request.user.is_authenticated:
        ...
        is_list_csv_file_dir_placestatic=os.path.join(settings.STATIC_URL, 'is_list_csv_file_dir')
    ...
    # end of if request was post
        ...
        sent_path=user.userprofile.current_genome_dir
        #return render(request,'event/home.html',{'myrange_x':myrange_x,'myrange_y':myrange_y,'squaredb':dbsquares,'question':question,'answers':answers,'overlays':overlays,'currentdir':sent_path,'currentdir_listing':currendir_listing})
        return render(request,'event/home.html',{'myrange_x':myrange_x,'myrange_y':myrange_y,'squaredb':dbsquares,'question':question,'overlays':overlays,'currentdir':sent_path,'currentdir_listing':currendir_listing})
